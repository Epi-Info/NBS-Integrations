...
namespace REDCapAPI {
	...
	// must be declared somewhere in code, or pulled from config file
        // RC URI and RC Token
        string strURI = @"https://redcapdemo.vanderbilt.edu/api/";
        string strPostToken = "77C82A9FAED961537E730B30E495EF56";
...
//----------------------------------------------
	    ...
	    // say RC fields are: studyid, redcap_event_name, radio_button1
            ...
            try
            {
                ...
                dtRCTable = GetTableFromAnyRc(strPostToken, "100", "", "", "", "Basic Demography Form", false, false);
